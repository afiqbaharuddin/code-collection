        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
              <!-- <span class="avatar-initial rounded-circle" style="background-color:#008080; font-size:20px">A</span> -->
            <div class="avatar-initial rounded-circle" style="background-color:#626520" id="profileImage1"></div>
            </div>
          </a>
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <a class="dropdown-item">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar avatar-online">
                      <div class="avatar-initial rounded-circle" style="background-color:#626520" id="profileImage2"></div>
                    </div>
                  </div>
                  <div class="flex-grow-1">
                    <?php $user = $this->session->userdata('Fullname'); ?>
                    <span id="user" class="fw-semibold d-block lh-1"><?php echo $user; ?></span>
            ...
            <li>
              <a class="dropdown-item"href="<?php echo base_url(); ?>auth/Login/logout" >
...
<script>
  $(document).ready(function() {
    ...
    var user = $('#user').text();
    var count = $.trim($('#user').text()).split(" ");
    var initials = [];

    for(var i=0; i<count.length; i++){
      initials[i] = count[i].charAt(0);
    }

    var profileImage1 = $('#profileImage1').text(initials.join(''));
    var profileImage2 = $('#profileImage2').text(initials.join(''));
  });
</script>
