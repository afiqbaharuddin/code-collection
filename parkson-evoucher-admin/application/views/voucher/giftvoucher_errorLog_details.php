...
>
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="content-header-row">
                <div class="content-header-left col-12 mb-4 mt-1">
                  <div class="row breadcrumbs-top">
                    <div class="col-12">
                      <h5 class="content-header-title float-left pr-1 mb-0">SCHEDULER IMPORT GIFT VOUCHER ERROR LOG</h5>
                      <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                          ...
                          <li class="breadcrumb-item active" style="margin-bottom:10px; color:#D6AD60">Scheduler Import Gift Voucher Error Log</li>
                        </ol>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mt-3">
                <div class="card-header">
                  <h5>Scheduler Import Gift Voucher Error Log</h5>
                </div>
                <div class="card-datatable">
                  <table class="table" id="scheduler_giftVoucher_errorLog">
    ...
    var scheduler_giftVoucher_errorLog = $('#scheduler_giftVoucher_errorLog').DataTable({
      "ordering": false,
      "searching": true,
      "processing": true,
      "serverSide": true,
      "scrollX": true,
      "ajax": {
          "url": "<?php echo base_url(); ?>voucher/VoucherDetails/scheduler_giftvoucher_errorLog/<?php echo $CSVFileId; ?>",
          "type": "POST",
          "data": function(data) {
    ...
    scheduler_giftVoucher_errorLog.on('xhr.dt', function ( e, settings, json, xhr ) {
      if(json != null) {
