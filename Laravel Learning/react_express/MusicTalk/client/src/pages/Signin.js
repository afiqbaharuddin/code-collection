  ...
  return (
    <div>
      ...
      >
        ...
        <label className="block mb-1 text-xl text-cyan-400" htmlFor="username">
          Username
        </label>
        <input
        ...
        />
        <label className="block mb-1 text-xl text-cyan-400" htmlFor="password">
          Password
        </label>
        <input
          className="w-full h-8 p-1 mb-6 focus:outline-none"
        ...
        <div className="flex justify-between">
          <button className="px-3 py-1 rounded-sm bg-cyan-400" type="button">
            Cancel
          </button>
