...
class VisitorController extends Controller
{
    ...
    function fetchall(Request $request){
        ...
        if ($request->ajax()) {
            ...
            $data = $query->get(['visitors.visitor_name', 'visitors.visitor_meet_person_name','visitors.visitor_department','visitors.visitor_enter_time','visitors.visitor_out_time',
            'visitors.visitor_status','users.name','visitors.id']);
