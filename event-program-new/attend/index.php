    ...
    if (isset($_GET['filter'])) {
        ...
        switch ($_GET['filter']) {
            case '1':
                ...
                //     $paxattend = selectall($conn, 'pax', "event_id = $id AND city_council = $cob AND event_date >= $from");
    ...
    if (isset($_GET['filter'])) {
        ...
        switch ($_GET['filter']) {
            case '1':
                ...
                // if(!empty($from)){
                //     $paxattend = selectall($conn, 'pax', "event_id = $id AND date_event > '$from'");
                //     // var_dump($paxattend);
                //     // var_dump($from);
                //     die();
                // }else{
    ...
    <script>
        $(document).ready(function() {
            var table = $('#pax').DataTable({
                    ...
                    'serverMethod': 'post',
                    'ajax': {
                        'url': 'ajaxcall.php?id=<?= $id ?><?php if (isset($filter)) {
                                                                echo "&filter=$filter";
                                                            }
                                                            if (isset($cob)) {
                                                                echo "&cob=$cob";
            ...
            // $("#pax_filter").prepend('<button class="btn btn-primary me-3" id="filter-table" >Filter Table</button>');
            // $("#pax_filter").prepend('<a class="btn btn-primary me-3" id="export" href="../export.php?id=<?= $id ?>&where=<?= $filter ?>">Export table</a>');
            var filter = "hide";
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown col-sm-3 me-3">
                                    <a class="dropdown-toggle btn btn-sm btn-primary" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                        Actions
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li>
                                        ...
                                        <li>
                                            <a id="export" class="dropdown-item" href="../export4.php?id=<?= $id ?>&where=<?= $filter ?>">Export table</a>
                    										...
                    										<?php if($role == "0"){?>
                    											...
                    											<li>
                    												<!-- <a class="dropdown-item" href="../controller/emailController.php?action=reminder&for=1d&id=<?= $id ?>">Reminder 1 day before</a> -->
                    												<a class="dropdown-item" href="javascript: void(0)">Reminder 1 day before</a>
                    											</li>
                    											<li>
                    												<!-- <a class="dropdown-item" href="../controller/emailController.php?action=reminder&for=0d&id=<?= $id ?>">Reminder On day</a> -->
